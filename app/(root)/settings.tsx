    ...
    return (
        <>
            ...
            <GestureHandlerRootView style={{ flex: 1, backgroundColor: Colors.dark, }}>
                <ScrollView contentContainerStyle={{ flex: 1, paddingTop: 20, paddingBottom: insets.bottom + 10, gap: 10 }}>
                ...
                <BottomSheetContainer 
                    ...
                    <View style={{padding:10, paddingTop:10, paddingBottom: insets.bottom + 30}}>
